...
<div class="">
    ...
    <div class="card mt-3">
        <div class="card-header">
            <label class="title-card"><i class="fa fa-list pr-1"></i>Danh sách hình thức viết báo</label>
        ...
        <div class="card-body" id="lstPaperType" style="max-height: 350px; overflow-y: auto;">
...
<script>
	...
	function actionSearch(){
    	var areaId ="lstPaperType";
        var url="/paper-type/search"
