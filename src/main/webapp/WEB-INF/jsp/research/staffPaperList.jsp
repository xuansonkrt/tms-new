...
<!--   pagesize="10" -->
    <display:table   class="table table-striped table-bordered" name="resultList" 
        ...
        <display:column property="code" title="Mã bài báo" autolink="true" />
        <display:column property="name" title="Tên bài báo" />
        <display:column property="author" title="Tác giả"   />
        <display:column property="researchPoint" title="Giờ chuẩn"  style="text-align: right;" />
    </display:table>
</logic:notEmpty>
